export default function DisplayCard(props) {
  ...
  const cards = projectList.map((prop) => {
    return (
      <div
        key={prop.key}
        className="block max-w-sm md:max-w-lg h-80 md:h-96 p-6 md:p-8 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark: dark:bg-zinc-800 dark:border-zinc-700 dark:hover:bg-zinc-700"
      >
